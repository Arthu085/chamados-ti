    ...
    <div class="offcanvas-body d-flex flex-column">
        <div class="flex-grow-1">
            <ul class="nav flex-column gap-2">
                <li><a href="/chamados-ti/views/dashboard.php" class="nav-link text-white hover-link">🏠 Dashboard</a>
                </li>
                <li><a href="/chamados-ti/views/tickets/new.php" class="nav-link text-white hover-link">📂 Novo
                        chamado</a>
                </li>
